  ...
  return (
    <div className="flex items-center justify-between border border-white border-t-0 border-r-0 border-l-0  h-24 py-4 w-full">
      <div className="flex text-xl gap-8 ">
        ...
        <nav className="hidden lg:flex lg:justify-between gap-5 text-white 4 ">
          <Link href="/learn" className="">
            LEARN
          </Link>
          <Link href="/">BLOG</Link>
          <Link href="/bookmarks">BOOKMARKS</Link>
          <Link href="/uikits">UI KIT</Link>
          <Link href="/lain">LAIN NYA</Link>
        </nav>
      </div>
      ...
      <div className="hidden lg:flex lg:items-center gap-6">
        ...
        <Link href={"#"}>
          <Image src="/dribble.png" width={30} height={30} className="" />
        </Link>
        <Link href={"#"} className="">
          <Image
        ...
        <button onClick={() => setNavbar(!navbar)}>
          {navbar ? (
            ...
            <Image
              src="/menu.png"
              alt="menu"
              className="focus:border-none active:border-none bg-white"
              width={40}
              height={40}
              priority
            />
